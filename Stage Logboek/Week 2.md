...
**Woensdag 8 Sept:**
	**Rooster Bijlage**
		![[Week 2-1788891239507.webp|437x229]]
	09:15 - Start van eerste hele observatie dag met 3 vwo plenair startmoment. 
		Docent:  Gwendolyn Rudolph
		Landbouwwerkweek is de week voor de Herfstvakantie. 
			 ***Wat is mijn rol met de landbouw werkweek?***
		Check in moment via "Lessonup": algemene vragen over hoe het nieuwe schooljaar en hoe dit ervaren wordt.
			1. Wat vindt je fijn dit jaar 
			2. Waar loop je tegen aan/ Waar maak je je al zorgen over.
			3. Wil je verder nog iets kwijt
		*Houding naar de klas: Langzame opbouw om zo sociale verantwoordelijkheid te kweken en de banden weer te versterken.*
		PLENDA (Planner/Agenda): Voorbereiding op plannen doormiddel van ruime indeling met extra ruimte om taken te verdelen in behapbare delen. 
			***Algemene Jaarplanning staat in een google drive.***
		*Inzet van peer to peer controle van agenda zodat iedereen een vergelijkbare planning heeft.*
		Plenair lesafsluiting. 
	09:45 - Eerste Engels les VWO2 
		*Gwendolyn wacht met spreken tot iedereen merkt dat ze staat te wachten. Begint in het engels en switcht dan naar nederlands. daarna neemt ze de tijd om de namen te leren met een klassikale namenronde.* 
		In mijn observatie viel het op dat leerlingen naast mij achterin de klas meer onrust veroorzaken dan voorin de klas. 
		*Introductie van de methode met daarbij een disclaimer over het wisselende niveau van voorkennis en dat de methode "Stepping Stones" Niet of slecht aansluit bij de werkelijke kennis van de leerlingen.*
			==//Klassikale weekopdracht: Word of the Week.== 
				==Pick a word that is uncommon== 
				==Write down it's meaning==
				==find a matching picture==
				==Declare word class==
				==Write two context sentences.==
